...
all_data = {
    ...
    "NumPy Relaxed API": [4.919703705934808, 5.045966051053256, 4.901492156088352, 4.895045991055667, 4.9723517938982695],
    "PyTorch CPU Strict API": [180.73112939088605],
    "PyTorch CPU Relaxed API": [1.1638194161932915, 1.120931203942746, 1.0023795650340617, 1.1782302970532328, 1.1800141278654337],
    "PyTorch CUDA Strict API": [281.28290371201],
    "Torch CUDA Relaxed API": [0.13685095217078924, 0.1785686588846147, 0.17490072012878954, 0.13612257200293243, 0.1353681399486959],
    "CuPy Strict API": [155.41026511299424],
    "CuPy Relaxed API": [0.23821475682780147, 0.24966995394788682, 0.24989571701735258, 0.25607424485497177, 0.24746034992858768],
}
...
# Set colors based on the library and add hatches for Relaxed API (note these
